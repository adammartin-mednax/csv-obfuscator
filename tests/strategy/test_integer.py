...
def no_test_will_return_an_integer_less_than_max_limit():
    max_value = 10
...
def no_test_will_return_an_integer_greater_than_min_limit():
    min_value = 1000
...
def no_test_will_explain_integer_configuration():
